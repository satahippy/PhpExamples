...
<p>
	Когда нужен последовательный доступ к элементам в режиме LIFO.
</p>

<h2>Сравнение с обычным массивом</h2>
<p>
	Что странно, в производительности <code>SplStack</code> всегда проигрывает. Но зато потребление памяти у него меньше, особенно при больших объёмах данных. 
</p>
